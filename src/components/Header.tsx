...
export default function Header() {
  return (
    <header id="home" className="relative h-screen flex items-center navy-gradient">
      <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center"></div>
      <div className="container mx-auto px-6 z-10">
        <div className="text-center">
          <h1 className="text-white text-4xl md:text-6xl font-serif font-bold mb-4 animate-fadeIn">
            John Paul Gatzie Reyes
          </h1>

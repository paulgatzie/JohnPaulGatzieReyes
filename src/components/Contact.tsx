          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">johnpaulgatziereyes@gmail.com</span>
              </div>
              
              <div className="flex items-center">
                <Phone className="w-6 h-6 text-navy-500 mr-4" />
                <span className="text-gray-700">(+63) 945-298-9702</span>
              </div>
              
              <div className="flex items-center">
                <MapPin className="w-6 h-6 text-navy-500 mr-4" />
                <span className="text-gray-700">Puerto Princesa City, Palawan</span>
              </div>
            </div>

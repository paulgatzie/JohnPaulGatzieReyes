      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/3">
            <div className="rounded-full overflow-hidden w-80 h-80 mx-auto border-6 border-navy-100 shadow-lg">
              <img 
                src="paul.jpg" 
                alt="Profile" 
          ...
          <div className="md:w-2/3">
            <h3 className="text-2xl font-serif text-navy-600 mb-4">
              Hello, I'm John Paul Gatzie Reyes
            </h3>
            
            <p className="text-gray-700 mb-4">
              I'm a passionate web developer and designer with over 1 year of experience creating 
            ...
            <div className="flex gap-4">
              <div className="text-center">
                <div className="text-navy-600 font-bold text-3xl">1+</div>
              ...
              <div className="text-center">
                <div className="text-navy-600 font-bold text-3xl">10+</div>
